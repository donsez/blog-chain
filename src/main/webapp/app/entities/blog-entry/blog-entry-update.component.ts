...
export class BlogEntryUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ blogEntry }) => {
            ...
            this.date = this.blogEntry.date != null ? this.blogEntry.date.format(DATE_TIME_FORMAT) : null;
        });
        this.blogService
            .query()
            .pipe(
    ...
    save() {
        this.isSaving = true;
        this.blogEntry.date = this.date != null ? moment(this.date, DATE_TIME_FORMAT) : null;
